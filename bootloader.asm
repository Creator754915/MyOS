...
start:
    ...
    ; Afficher un caractère à l'écran => tester le bootloader
    mov ah, 0x0E          ; Appel le service vidéo BIOS pour afficher un caractère
    mov al, 'B'           ; Caractère à afficher
    int 0x10              ; Fermer le BIOS
...
times 510 - ($-$$) db 0   ; Remplir le bootloader jusqu'a 510 octets
